...
data['prognosis'] = le_prognosis.fit_transform(data['prognosis'].astype(str))
...
with open('models/label_encoder_prognosis.pkl', 'wb') as le_prognosis_file:
    pickle.dump(le_prognosis, le_prognosis_file)
